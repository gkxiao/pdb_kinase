...
- **冗余度极高**：10,669 人类链 / 309 蛋白 ≈ **每个蛋白平均 34 条结构**—— 比之前全库的 25 还高。同一激酶的多种构象（DFG-in/out、αC-helix 开合、不同抑制剂诱导的扩张口袋）正好是想要的 "口袋形状多样性"，查询时能命中天然构象全集。
- 一个激酶的不同突变体也归属在同一个激酶里，在这里并没有对此进行区分。
